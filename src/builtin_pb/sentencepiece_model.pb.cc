...
class TrainerSpec::_Internal {
 public:
  ...
  static void set_has_old_vocab(HasBits* has_bits) {
    (*has_bits)[0] |= 512u;
  }
};
...
TrainerSpec::TrainerSpec(const TrainerSpec& from)
  ...
  old_vocab_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_old_vocab()) {
    old_vocab_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_old_vocab(), 
      GetArena());
  }
...
void TrainerSpec::SharedDtor() {
  ...
  old_vocab_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:sentencepiece.TrainerSpec)
  ...
  if (cached_has_bits & 0x00000300u) {
    ...
    if (cached_has_bits & 0x00000200u) {
      old_vocab_.ClearNonDefaultToEmpty();
    }
  }
    ...
    switch (tag >> 3) {
      ...
      case 54:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 176)) {
          ...
          min_freq_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 55:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 186)) {
          auto str = _internal_mutable_old_vocab();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* TrainerSpec::_InternalSerialize(
  ...
  if (cached_has_bits & 0x01000000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(54, this->_internal_min_freq(), target);
  }

  // optional string old_vocab = 55;
  if (cached_has_bits & 0x00000200u) {
    target = stream->WriteStringMaybeAliased(
        55, this->_internal_old_vocab(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:sentencepiece.TrainerSpec)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00000200u) {
      _internal_set_old_vocab(from._internal_old_vocab());
    }
    if (cached_has_bits & 0x00000400u) {
...
void TrainerSpec::InternalSwap(TrainerSpec* other) {
  ...
  old_vocab_.Swap(&other->old_vocab_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
